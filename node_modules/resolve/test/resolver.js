...
test('other path', function (t) {
    ...
    resolve('origin', { basedir : dir, paths: [otherDir] }, function (err, res) {
        if (err) t.fail(err);
    ...
    resolve('origin', { basedir : dir, }, function (err, res) {
        t.equal(err.message, "Cannot find module 'origin' from '" + path.resolve(dir) + "'");
    });
