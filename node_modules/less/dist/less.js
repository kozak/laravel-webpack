...
module.exports = function(SourceMapBuilder) {
    ...
    ParseTree.prototype.toCSS = function(options) {
        ...
        try {
            evaldRoot = transformTree(this.origin, options);
        } catch (e) {
...
var Parser = function Parser(context, imports, fileInfo) {
    ...
    return {
        ...
        parse: function (str, callback, additionalData) {
            ...
            // with the `origin` property set to true, so no `{}` are
        ...
        parsers: parsers = {
            ...
            // block rule: at the origin level.
            //
            primary: function () {
...
Import.prototype.accept = function (visitor) {
    ...
    if (!this.options.plugin && !this.options.inline && this.origin) {
        this.origin = visitor.visit(this.origin);
    }
};
...
Import.prototype.doEval = function (context) {
    ...
    if (this.options.plugin) {
        ...
        if ( registry && this.origin && this.origin.functions ) {
            registry.addMultiple( this.origin.functions );
        }
        return [];
    }
    ...
    if (this.options.inline) {
        var contents = new Anonymous(this.origin, 0,
          {
        ...
        ruleset = new Ruleset(null, this.origin.rules.slice(0));
...
// Returns true if this node represents origin of ast imported by reference
...
Ruleset.prototype.variables = function () {
    if (!this._variables) {
        this._variables = !this.rules ? {} : this.rules.reduce(function (hash, r) {
            ...
            // guard against origin being a string (in the case of inlined less)
...
Ruleset.prototype.genCSS = function (context, output) {
    ...
    // If this is the origin node, we don't render
    // a selector, or {}.
    if (!this.origin) {
    ...
    checkValidNodes: function(rules, isRoot) {
        ...
        for (var i = 0; i < rules.length; i++) {
            ...
            if (isRoot && ruleNode instanceof tree.Rule && !ruleNode.variable) {
                throw { message: "Properties must be inside selector blocks. They cannot be in the origin",
