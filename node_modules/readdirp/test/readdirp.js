...
test('\nreading origin without filter', function (t) {
  t.plan(2);
...
test('\nreading origin without filter using lstat', function (t) {
  t.plan(2);
...
test('\nreading origin with symlinks using lstat', function (t) {
  t.plan(2);
...
test('\nreading origin using glob filter', function (t) {
  // normal
  t.test('\n# "*.ext1"', function (t) {
    t.plan(1);
...
test('\n\nreading origin using function filter', function (t) {
...
test('\nreading origin specifying maximum depth', function (t) {
  t.test('\n# depth 1', function (t) {
    t.plan(1);
...
test('\nreading origin with no recursion', function (t) {
  t.test('\n# depth 0', function (t) {
    t.plan(1);
