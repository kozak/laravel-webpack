...
define(function (require, exports, module) {
  ...
  exports['test that the `sources` field has the original sources'] = function (assert, util) {
    ...
    sources = map.sources;
    assert.equal(sources[0], '/the/origin/one.js');
    assert.equal(sources[1], '/the/origin/two.js');
  ...
  exports['test that the source origin is reflected in a mapping\'s source field'] = function (assert, util) {
    var map;
    var mapping;
    ...
    assert.equal(mapping.source, '/the/origin/two.js');

    mapping = map.originalPositionFor({
      line: 1,
      column: 1
    });
    assert.equal(mapping.source, '/the/origin/one.js');
  ...
  exports['test mapping tokens back exactly'] = function (assert, util) {
    ...
    util.assertMapping(1, 1, '/the/origin/one.js', 1, 1, null, map, assert);
    util.assertMapping(1, 5, '/the/origin/one.js', 1, 5, null, map, assert);
    util.assertMapping(1, 9, '/the/origin/one.js', 1, 11, null, map, assert);
    util.assertMapping(1, 18, '/the/origin/one.js', 1, 21, 'bar', map, assert);
    util.assertMapping(1, 21, '/the/origin/one.js', 2, 3, null, map, assert);
    util.assertMapping(1, 28, '/the/origin/one.js', 2, 10, 'baz', map, assert);
    util.assertMapping(1, 32, '/the/origin/one.js', 2, 14, 'bar', map, assert);

    util.assertMapping(2, 1, '/the/origin/two.js', 1, 1, null, map, assert);
    util.assertMapping(2, 5, '/the/origin/two.js', 1, 5, null, map, assert);
    util.assertMapping(2, 9, '/the/origin/two.js', 1, 11, null, map, assert);
    util.assertMapping(2, 18, '/the/origin/two.js', 1, 21, 'n', map, assert);
    util.assertMapping(2, 21, '/the/origin/two.js', 2, 3, null, map, assert);
    util.assertMapping(2, 28, '/the/origin/two.js', 2, 10, 'n', map, assert);
  };
  ...
  exports['test mapping tokens fuzzy'] = function (assert, util) {
    ...
    util.assertMapping(1, 20, '/the/origin/one.js', 1, 21, 'bar', map, assert, true);
    util.assertMapping(1, 30, '/the/origin/one.js', 2, 10, 'baz', map, assert, true);
    util.assertMapping(2, 12, '/the/origin/two.js', 1, 11, null, map, assert, true);

    // Finding generated positions
    util.assertMapping(1, 18, '/the/origin/one.js', 1, 22, 'bar', map, assert, null, true);
    util.assertMapping(1, 28, '/the/origin/one.js', 2, 13, 'baz', map, assert, null, true);
    util.assertMapping(2, 9, '/the/origin/two.js', 1, 16, null, map, assert, null, true);
  };
  ...
  exports['test eachMapping'] = function (assert, util) {
    ...
    map.eachMapping(function (mapping) {
      ...
      assert.ok(mapping.source === '/the/origin/one.js' || mapping.source === '/the/origin/two.js');
  ...
  exports['test that we can get the original sources for the sources'] = function (assert, util) {
    ...
    assert.throws(function () {
      map.sourceContentFor("/the/origin/three.js");
    }, Error);
    assert.throws(function () {
  ...
  exports['test sourceRoot + originalPositionFor'] = function (assert, util) {
    ...
    // Should always have the prepended source origin
  ...
  exports['test absolute path, but same host sources'] = function (assert, util) {
    ...
    assert.equal(sources[0], 'http://example.com/original.js',
                 'Source should be relative the host of the source origin.');
  };
