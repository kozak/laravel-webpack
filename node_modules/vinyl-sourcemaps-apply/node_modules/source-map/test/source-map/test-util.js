...
define(function (require, exports, module) {
  ...
  exports['test relative()'] = function (assert, util) {
    assert.equal(libUtil.relative('/the/origin', '/the/origin/one.js'), 'one.js');
    assert.equal(libUtil.relative('/the/origin', '/the/rootone.js'), '/the/rootone.js');

    assert.equal(libUtil.relative('', '/the/origin/one.js'), '/the/origin/one.js');
    assert.equal(libUtil.relative('.', '/the/origin/one.js'), '/the/origin/one.js');
    assert.equal(libUtil.relative('', 'the/origin/one.js'), 'the/origin/one.js');
    assert.equal(libUtil.relative('.', 'the/origin/one.js'), 'the/origin/one.js');
