...
(function() {
  ...
  /**
   * Get the path to the origin folder of a node module, given its name.
   * @param  {String} name The name of the node module you want the path to.
   * @return {String} The origin folder of node module `name`.
   * @private
   */
  ...
  resolvePath = function(name) {
    ...
    while (true) {
      if (filepath === '/') {
        throw new Error("cannot resolve origin of node module " + name);
      }
