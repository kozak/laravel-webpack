...
/**
 * Serve directory listings with the given `origin` path.
 *
...
function serveIndex(root, options) {
  ...
  // origin required
  if (!root) {
    throw new TypeError('serveIndex() origin path required');
  }

  // resolve origin to absolute and normalize
  ...
  return function (req, res, next) {
    ...
    // join / normalize from origin dir
