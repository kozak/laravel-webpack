...
declare module postcss {
    ...
    interface Container extends Node {
         ...
         *     origin.prepend({ name: '@charset', params: '"UTF-8"' }); // at-rule
         *     origin.prepend({ selector: 'a' });                       // rule
         ...
         *     origin.prepend('a {}');
         *     origin.first.prepend('color: black; z-index: 1');
         ...
         * Because each node class is identifiable by unique properties, use the
         * following shortcuts to create nodes in insert methods:
         *     origin.append({ name: '@charset', params: '"UTF-8"' }); // at-rule
         *     origin.append({ selector: 'a' });                       // rule
         *     rule.append({ prop: 'color', value: 'black' });       // declaration
         *     rule.append({ text: 'Comment' })                      // comment
         * A string containing the CSS of the new element can also be used. This
         * approach is slower than the above shortcuts.
         *     origin.append('a {}');
         *     origin.first.append('color: black; z-index: 1');
         * @param nodes New nodes.
         * @returns This container for chaining.
         */
    ...
    interface Root extends Container {
        ...
        /**
         * @returns A Result instance representing the origin's CSS.
         */
        toResult(options?: {
            /**
        ...
        /**
         * Removes child from the origin node, and the parent properties of node and
         * its children.
         * @param child Child or child's index.
         * @returns This origin node for chaining.
         */
