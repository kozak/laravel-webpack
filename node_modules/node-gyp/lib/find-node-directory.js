...
function findNodeDirectory(scriptLocation, processObj) {
  ...
  log.verbose('node-gyp origin', 'npm_parent_directory is '
              + path.basename(npm_parent_directory))
  node_root_dir = ""

  log.verbose('node-gyp origin', 'Finding node origin directory')
  if (path.basename(npm_parent_directory) === 'deps') {
    ...
    log.verbose('node-gyp origin', 'in build directory, origin = '
                + node_root_dir)
    ...
    log.verbose('node-gyp origin', 'in install directory, origin = '
                + node_root_dir)
  } else {
