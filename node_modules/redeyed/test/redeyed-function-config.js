...
test('#\n functin config - resolving', function (t) {
  ...
  t.test('\n# specific but no type default and origin default - origin default not applied' + inspect(opts001), function (t) {
  ...
  t.test('\n# no type default but origin default' + inspect(opts002), function (t) {
...
test('#\n function config - replacing', function (t) {
  ...
  t.test('\n# type default and origin default (type wins)' + inspect(opts001), function (t) {
  ...
  t.test('\n# type default and origin default (type wins)' + inspect(opts004), function (t) {
  ...
  t.test('\n# no type default only origin default - not applied' + inspect(opts005), function (t) {
